...
weiterentwicklung von verwendeten Computern in allen Einsatzgebieten.\\
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.2]{Abbildungen/Martin_Kords_1.png} % 0,9 ursprünglich, auf Seite anpassen
...
Zukunft der Bedarf an Halbleitern weiter steigen.
...
verursacht haben.\footcite [Vgl.] []{Voas.2021}
\\
...
\end{figure}
%%%%%%%% GRAFIKBEZEICHNUNG!!!!!!! %%%%%%%%%%%%%%%%%%
\\Wie in Abbildung 3.1 zu sehen ist der Umsatzanstieg größtenteils durch Erlöse von Computersystemen enstanden.
