...
verwenden GPU a as Service Anbieter eine Vielzahl an GPUs auf einem Server. 
...
Betriebssystem, auch Kernel bezeichnet. Das wird skalierbar angewendet und auch eine 
Vielzahl an Kernels betrieben als GPU as a Service Dienstleister. \footcite [] [] {Wang.2017}
\\%
\begin{figure}[h]
  \centering
  \includegraphics[scale=1.3]{Abbildungen/wang1.png} 
