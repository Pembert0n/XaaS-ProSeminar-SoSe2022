...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.75]{Abbildungen/voas1.png} % 0,9 ursprünglich, auf Seite anpassen
  \caption[]{Worldwide semiconductor revenues in 2019 and 2020 (dollar, billions)}
\end{figure}
\\Wie in Abbildung 3.2 zu sehen ist der Umsatzanstieg größtenteils durch Erlöse von Computersystemen enstanden.
...
\\ Der steigende Bedarf allein ist aber wie angeührt nicht der einzige Faktor. Die Produktion 
von Halbleitern stagniert aufgrund diverser Gründe wie Naturdisaster, welche die Produktionsunternehmen behindern.
\footcite [Vgl.] []{Voas.2021}
